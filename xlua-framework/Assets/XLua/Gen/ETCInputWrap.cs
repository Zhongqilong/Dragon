		    ...
		    try {
                ...
                
                {
                    string _ctrlName = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = ETCInput.GetControlVisible( _ctrlName );
		    ...
		    try {
                ...
                
                {
                    string _ctrlName = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = ETCInput.GetControlActivated( _ctrlName );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _ctrlName = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = ETCInput.GetControlSwipeIn( _ctrlName );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    bool _value = LuaAPI.lua_toboolean(L, 2);
                        ...
                        var gen_ret = ETCInput.GetControlSwipeOut( _ctrlName, _value );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _ctrlName = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = ETCInput.GetDPadAxesCount( _ctrlName );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _ctrlName = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = ETCInput.GetControlJoystick( _ctrlName );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _ctrlName = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = ETCInput.GetControlDPad( _ctrlName );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _ctrlName = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = ETCInput.GetControlTouchPad( _ctrlName );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _ctrlName = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = ETCInput.GetControlButton( _ctrlName );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _axisName = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = ETCInput.GetAxisEnabled( _axisName );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _axisName = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = ETCInput.GetAxisInverted( _axisName );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _axisName = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = ETCInput.GetAxisDeadValue( _axisName );
		    ...
		    try {
                ...
                
                {
                    string _axisName = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = ETCInput.GetAxisSensitivity( _axisName );
                        LuaAPI.lua_pushnumber(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _axisName = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = ETCInput.GetAxisThreshold( _axisName );
                        LuaAPI.lua_pushnumber(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _axisName = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = ETCInput.GetAxisInertia( _axisName );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _axisName = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = ETCInput.GetAxisInertiaSpeed( _axisName );
                        LuaAPI.lua_pushnumber(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _axisName = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = ETCInput.GetAxisInertiaThreshold( _axisName );
                        LuaAPI.lua_pushnumber(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _axisName = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = ETCInput.GetAxisAutoStabilization( _axisName );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _axisName = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = ETCInput.GetAxisAutoStabilizationSpeed( _axisName );
                        LuaAPI.lua_pushnumber(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _axisName = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = ETCInput.GetAxisAutoStabilizationThreshold( _axisName );
                        LuaAPI.lua_pushnumber(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _axisName = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = ETCInput.GetAxisClampRotation( _axisName );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _axisName = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = ETCInput.GetAxisClampRotationMinValue( _axisName );
                        LuaAPI.lua_pushnumber(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _axisName = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = ETCInput.GetAxisClampRotationMaxValue( _axisName );
                        LuaAPI.lua_pushnumber(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _axisName = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = ETCInput.GetAxisDirectTransform( _axisName );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _axisName = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = ETCInput.GetAxisDirectAction( _axisName );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _axisName = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = ETCInput.GetAxisAffectedAxis( _axisName );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _axisName = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = ETCInput.GetAxisOverTime( _axisName );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _axisName = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = ETCInput.GetAxisOverTimeStep( _axisName );
                        LuaAPI.lua_pushnumber(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _axisName = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = ETCInput.GetAxisOverTimeMaxValue( _axisName );
                        LuaAPI.lua_pushnumber(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _axisName = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = ETCInput.GetAxis( _axisName );
                        LuaAPI.lua_pushnumber(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _axisName = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = ETCInput.GetAxisSpeed( _axisName );
                        LuaAPI.lua_pushnumber(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _axisName = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = ETCInput.GetAxisDownUp( _axisName );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _axisName = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = ETCInput.GetAxisDownDown( _axisName );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _axisName = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = ETCInput.GetAxisDownRight( _axisName );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _axisName = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = ETCInput.GetAxisDownLeft( _axisName );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _axisName = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = ETCInput.GetAxisPressedUp( _axisName );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _axisName = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = ETCInput.GetAxisPressedDown( _axisName );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _axisName = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = ETCInput.GetAxisPressedRight( _axisName );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _axisName = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = ETCInput.GetAxisPressedLeft( _axisName );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _buttonName = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = ETCInput.GetButtonDown( _buttonName );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _buttonName = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = ETCInput.GetButton( _buttonName );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _buttonName = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = ETCInput.GetButtonUp( _buttonName );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _buttonName = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = ETCInput.GetButtonValue( _buttonName );
                        LuaAPI.lua_pushnumber(L, gen_ret);
