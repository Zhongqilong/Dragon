...
{
    public class LuaMonoInterfaceBridge : LuaBase, LuaMonoInterface
    {
	    public static LuaBase __Create(int reference, LuaEnv luaenv)
		{
		    return new LuaMonoInterfaceBridge(reference, luaenv);
		}
		
		public LuaMonoInterfaceBridge(int reference, LuaEnv luaenv) : base(reference, luaenv)
        {
        }
		
        
		void LuaMonoInterface.Awake()
		{
		...
		void LuaMonoInterface.OnDestroy()
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		void LuaMonoInterface.OnShow(object data)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
