...
namespace UnityEngine.UI
{
    ...
    static public class NGUITools
    {
        ...
        static public int CalculateNextDepth(GameObject go)
        {
            ...
            {
                int depth = -1;
                UIPanel[] widgets = go.GetComponentsInChildren<UIPanel>();
        ...
        static public int AdjustDepth(GameObject go, int adjustment)
        {
            if (go != null)
            {
                ...
                else
                {
                    ...
                    UIPanel[] widgets = go.GetComponentsInChildren<UIPanel>(true);
        ...
        {
            NormalizeWidgetDepths(FindActive<UnityEngine.UI.UIPanel>());
        }
        ...
        {
            NormalizeWidgetDepths(go.GetComponentsInChildren<UnityEngine.UI.UIPanel>());
        }
        ...
        static public void NormalizeWidgetDepths(UnityEngine.UI.UIPanel[] list)
        {
            int size = list.Length;

            if (size > 0)
            {
                Array.Sort(list, UIPanel.FullCompareFunc);
        ...
        static public void NormalizePanelDepths()
        {
            ...
            if (size > 0)
            {
                Array.Sort(list, UnityEngine.UI.UIPanel.CompareFunc);
