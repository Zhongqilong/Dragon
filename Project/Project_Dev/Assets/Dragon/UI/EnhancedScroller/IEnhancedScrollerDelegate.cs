...
namespace EnhancedUI.EnhancedScroller
{
    ...
    /// </summary>
    public interface IEnhancedScrollerDelegate: System.IDisposable
    {
        //Create Instance 
        GameObject Instantiate(string cellIdentifier, Transform parent);
        ...
        EnhancedScrollerCellView GetActiveCellView(object obj);
        void UpdateListSize();
    }
}