...
namespace Uqee.Resource
{
    ...
    public abstract class AbstractProcessor<T> : Singleton<T>, IHotFix, IProcessor where T : class, IProcessor, new()
    {
    ...
    public abstract class AbstractResourceProcessor<T> : AbstractProcessor<T>, IHotFix, IResourceProcessor where T : class, IResourceProcessor, new()
    {
