...
namespace PathologicalGames
{
    ...
    public class SpawnPoolsDict : IDictionary<string, SpawnPool>
    {
        ...
        private bool assertValidPoolName(string poolName)
        {
            ...
            {
                UnityEngine.Debug.Log(string.Format("A pool with the name '{0}' already exists",
                                        poolName));
                return false;
            }
        ...
        public void DestroyAll()
        {
			...
			{
				UnityEngine.Debug.Log("DESTROYING: " + pool.gameObject.name);
        ...
        internal void Add(SpawnPool spawnPool)
        {
            ...
            {
                UnityEngine.Debug.LogError(string.Format("A pool with the name '{0}' already exists. " +
